...
namespace ClaimRequest.Infrastructure.Migrations
{
    ...
    [Migration("20250211182424_AddApproverAndSupervisorForClaim")]
    partial class AddApproverAndSupervisorForClaim
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClaimRequest.Domain.Claims.Claim", b =>
                {
                    ...
                    b.Property<Guid>("SuperivisorId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SuperivisorId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SuperivisorId");

                    b.HasIndex("SuperivisorId1");
            ...
            modelBuilder.Entity("ClaimRequest.Domain.Claims.Claim", b =>
                {
                    ...
                    b.HasOne("ClaimRequest.Domain.Users.User", null)
                        .WithMany()
                        .HasForeignKey("SuperivisorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClaimRequest.Domain.Users.User", "Superivisor")
                        .WithMany()
                        .HasForeignKey("SuperivisorId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
