...
namespace ClaimRequest.Infrastructure.Migrations
{
    ...
    [Migration("20250328001607_add nighthours dayhours for overtime effort")]
    partial class addnighthoursdayhoursforovertimeeffort
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClaimRequest.Domain.ClaimOverTime.OverTimeRequest", b =>
                {
                    ...
                    b.Property<bool>("HasWeekday")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasWeekend")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ClaimRequest.Domain.CompanySettings.CompanySetting", b =>
                {
                    ...
                    b.Property<decimal>("FinePerAbnormalCase")
                        .HasColumnType("numeric");

                    b.Property<decimal>("FinePerLateEarlyCase")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("SalaryPerOvertimeHour")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("ClaimRequest.Domain.Users.SalaryPerMonth", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("AbnormalCases")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LateEarlyLeaveCases")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SalaryPerMonth", "public");
                });
            ...
            modelBuilder.Entity("ClaimRequest.Domain.ClaimOverTime.OverTimeRequest", b =>
                {
                    ...
                    b.HasOne("ClaimRequest.Domain.SitesAndRooms.Room", "Room")
                        .WithMany()
            ...
            modelBuilder.Entity("ClaimRequest.Domain.Projects.Project", b =>
                {
                    b.HasOne("ClaimRequest.Domain.Users.Department", "Department")
                        .WithMany("Projects")
