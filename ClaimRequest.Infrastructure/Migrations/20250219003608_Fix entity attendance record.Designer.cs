...
namespace ClaimRequest.Infrastructure.Migrations
{
    ...
    [Migration("20250219003608_Fix entity attendance record")]
    partial class Fixentityattendancerecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClaimRequest.Domain.Claims.Claim", b =>
                {
                    ...
                    b.HasOne("ClaimRequest.Domain.AttendanceRecords.AttendanceRecord", "AttendanceRecords")
                        .WithOne("Claim")
                        .HasForeignKey("ClaimRequest.Domain.Claims.Claim", "AttendanceId");
